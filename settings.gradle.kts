...
dependencyResolutionManagement {
    versionCatalogs {
        create("deps") {
            ...
            alias("ktor-client").to("io.ktor:ktor-client-core:$ktor")
            alias("ktor-okhttp").to("io.ktor:ktor-client-okhttp:$ktor")
            alias("ktor-server").to("io.ktor:ktor-server-core:$ktor")
            alias("ktor-netty").to("io.ktor:ktor-server-netty:$ktor")
            alias("ktor-websockets").to("io.ktor:ktor-client-websockets:$ktor")
